            ...
            child: Column(
              ...
              children: [
                ...
                buildCupertinoTextField('Email Address', _emailController,
                    false, context, [AutofillHints.email]), // Email text field
  ...
  return CupertinoButton(
    onPressed: () async {
      if (_emailController.text.trim().isEmpty) {
        ...
        showErrorDialog(context, 'Email Required', 'Please enter your email address.');
        return;
      }
      ...
      if (!_emailController.text.trim().contains('@') ||
        ...
        showErrorDialog(context, 'Invalid Email', 'Please enter a valid email address.');
        return;
      }
